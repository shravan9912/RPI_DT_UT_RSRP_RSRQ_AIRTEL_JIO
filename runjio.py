...
def dsusonly():
    ...
    int(file_size)
    while file_size < 196000:
       #if os.path.exists("signal/"+ststr+".pdf"):
          #os.remove("signal/"+ststr+".pdf")
       pdfkit.from_url('http://192.168.1.1/',"signal/"+ststr+".pdf")
       if os.path.exists("signal/"+ststr+".pdf"):
          file_size = os.path.getsize("signal/"+ststr+".pdf")
    ...
    etstr=str(et)
    pdfkit.from_url('http://192.168.1.1/',"signal/"+etstr+".pdf")
    file_size = os.path.getsize("signal/"+etstr+".pdf")
    int(file_size)
    while file_size < 196000:
       #if os.path.exists("signal/"+etstr+".pdf"):
          #os.remove("signal/"+etstr+".pdf")       
       pdfkit.from_url('http://192.168.1.1/',"signal/"+etstr+".pdf")
       if os.path.exists("signal/"+etstr+".pdf"):
          file_size = os.path.getsize("signal/"+etstr+".pdf")
